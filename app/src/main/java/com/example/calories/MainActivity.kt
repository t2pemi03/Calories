...
fun CalorieScreen(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        GenderChoice(male = male, setGenderMale = { male = it })
        ...
        Calc(male = male, weight = weight, intensity = intensity, setResult = { result = it })
    }
}
...
@Composable
fun Calc(male: Boolean, weight: Int, intensity: Float, setResult: (Int) -> Unit) {
    Button(
        onClick = {
            if (male) {
